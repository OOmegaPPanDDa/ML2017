...
record = []
#record.append(['trian_volume_ratio', 'train_volume', 'train_RMSE','valid_RMSE'])
...
for the_i in range(1, 11):
    
    train_volume_ratio = round(0.1 * the_i, 2)
    ...
    record.append([train_volume_ratio, train_volume, train_mse ** 0.5, valid_mse ** 0.5])




record = np.asarray(record)
plt.plot(record[:,1], record[:,3])
plt.xlabel('The amount of training data')
